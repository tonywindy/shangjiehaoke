    ...
    <>
      <div className="app">
        ...
        <div className="video-background">
          ...
          >
            {/* 你可以替换这个视频源为你自己的视频文件 */}
            <source src="/shangjiehaoke/your-video.mp4" type="video/mp4" />
            {/* 如果浏览器不支持视频，显示备用内容 */}
        ...
        <nav className="navbar">
          <div className="nav-container">
            ...
            <div className="nav-menu">
              ...
              <a href="/shangjiehaoke/works.html" className="nav-link">些许尝试</a>
          <a href="/shangjiehaoke/contact.html" className="nav-link">一点想法</a>
              <div className="feedback-container">
                <span className="nav-link" style={{cursor: 'pointer'}}>意见之箱</span>
                <div className="qr-popup">
                  <img src="/shangjiehaoke/erweima.png" alt="公众号二维码" className="qr-code" />
